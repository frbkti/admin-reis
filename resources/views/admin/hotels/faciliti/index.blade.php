    ...
    <div class="card mt-3 border shadow" style="padding: 30px;">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between mb-4">
                <h5 class="card-title fw-semibold">Hotel Facilities</h5>
                <!-- Button Create -->
                <a href="{{ route('admin.hotels.faciliti.create') }}" class="btn btn-primary">Add Facility</a>
            </div>
            <hr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-bottom-0">
                              <a href="{{ route('admin.hotels.faciliti.edit', $facility->id) }}" class="btn btn-warning btn-sm">
                                  <i class="ti ti-pencil"></i> 
                              </a>
                              <form action="{{ route('admin.hotels.faciliti.destroy', $facility->id) }}" method="POST" style="display:inline;">
                                  @csrf
                                  @method('DELETE')
