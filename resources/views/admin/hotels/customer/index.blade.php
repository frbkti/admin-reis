        ...
        <div class="card mt-3 border shadow" style="padding: 30px;">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between mb-4">
                    <h5 class="card-title fw-semibold">Customer Informasi</h5>
                    <!-- Button Create -->
                    <a href="{{ route('admin.hotels.customer.create') }}" class="btn btn-primary">Add Customer</a>
                </div>
                <hr>
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        <thead class="text-dark fs-4">
                            <tr>
                                ...
                                <th class="border-bottom-0"><h6 class="fw-semibold mb-0">Identity Type</h6></th>
                                <th class="border-bottom-0"><h6 class="fw-semibold mb-0">Identity Number</h6></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0"><h6 class="fw-semibold mb-1">{{ $customer->order->fullname}}</h6></td>
                                <td class="border-bottom-0"><p class="mb-0 fw-normal">{{ $customer->contactNumber }}</p></td>
                                <td class="border-bottom-0"><p class="mb-0 fw-normal">{{ $customer->email }}</p></td>
                                <td class="border-bottom-0"><p class="mb-0 fw-normal">{{ $customer->identityType }}</p></td>
                                <td class="border-bottom-0"><p class="mb-0 fw-normal">{{ $customer->identityNumber }}</p></td>
                                <td class="border-bottom-0">
                                    <a href="{{ route('admin.hotels.customer.edit', $customer->id) }}" class="btn btn-warning btn-sm">
                                        <i class="ti ti-pencil"></i> 
                                    </a>
                                    <form action="{{ route('admin.hotels.customer.destroy', $customer->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
