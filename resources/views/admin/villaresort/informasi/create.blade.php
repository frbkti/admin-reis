      ...
      <div class="container-fluid">
        <div class="border shadow">
            <div class="card-body p-5">
                <form action="{{ route('admin.villaresort.informasi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="villaresortname" class="form-label">Villa/Resort Name</label>
                        <input type="text" class="form-control" id="villaresortname" name="villaresortname" required>
                    </div>
                    <div class="mb-3">
