        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('admin.villaresort.home') }}" aria-expanded="false">
                <span>
            ...
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
              <span class="hide-menu">Villa & Resort</span>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('admin.villaresort.informasi.index') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('admin.villaresort.rooms.index') }}" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{ route('admin.villaresort.faciliti.index') }}" aria-expanded="false">
                <span>
