        ...
        <div class="card mt-3 border shadow" style="padding: 30px;">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between mb-4">
                    <h5 class="card-title fw-semibold">Villa Resort Rooms</h5>
                    <!-- Button Create -->
                    <a href="{{ route('admin.villaresort.rooms.create') }}" class="btn btn-primary">Add Room</a>
                </div>
                <hr>
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0"><h6 class="fw-semibold mb-1">{{ $room->villaResort->villaresortname }}</h6></td>
                                ...
                                <td class="border-bottom-0">
                                  <a href="{{ route('admin.villaresort.rooms.edit', $room->id) }}" class="btn btn-warning btn-sm">
                                      <i class="ti ti-pencil"></i> 
                                  </a>
                                  <form action="{{ route('admin.villaresort.rooms.destroy', $room->id) }}" method="POST" style="display:inline;">
                                      @csrf
                                      @method('DELETE')
